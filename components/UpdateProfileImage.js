...
const UpdateProfileImage = ({ loading, profilePictureUrl, uid, isOwner }) => {
    ...
    return (
        <div className='h-24 w-24 sm:h-32 sm:w-32 lg:h-40 lg:w-40 rounded-full overflow-hidden flex'>
            { loading ? <Skeleton className='leading-loose' height='160px' width='160px' /> : <div className=" relative text-offwhite-50 w-full h-full flex items-center justify-center bg-tertiary-dark">
