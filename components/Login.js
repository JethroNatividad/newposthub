        ...
        >
            <div className='min-h-screen space-y-10 px-3 flex flex-col lg:flex-row items-center lg:justify-around'>
                ...
                <div className='text-offwhite-50 text-center lg:text-left'>
                    ...
                    <p className='text-lg md:text-xl max-w-md'>Connect with friends and the world around you on Posthub. vurl:{ process.env.NEXT_PUBLIC_VERCEL_URL }burl:{ process.env.BASE_URL }url:{ process.env.URL }vuri:{ process.env.VERCEL_URI }</p>
                </div>
